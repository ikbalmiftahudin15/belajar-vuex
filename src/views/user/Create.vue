<template>
    <div>
        <h2>Create User</h2>
        <from @submit.prevent="createUser">
            <label>Email:</label>
            ...
            <button type="submit" class="grid cursor-pointer select-none rounded-md border
             border-indigo-500 bg-indigo-500 py-2 px-5
              text-center align-middle text-sm text-white shadow hover:border-indigo-600 hover:bg-indigo-600 hover:text-white focus:border-indigo-600 focus:bg-indigo-600 focus:text-white focus:shadow-none">Create User</button>
        </from>
    </div>
</template>
...
export default {
    ...
    computed: {
        ...mapState("notification", ["notidication"]),
    },
    methods: {
